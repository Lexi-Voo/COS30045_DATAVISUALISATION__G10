    ...
    d3.json("https://raw.githubusercontent.com/rowanhogan/australian-states/master/states.geojson")
        .then(geoData => {
            ...
            svg.append("text")
                ...
                // Minimal corner tip for the map
            svg.append("g")
                .attr("transform", `translate(${width - 450}, ${margin.top + 15})`) // shifted left and down a bit
                .call(g => {
                    g.append("text")
                        .attr("x", 0)
                        .attr("y", 0)
                        ...
                        .style("font-weight", "bold")
                        .style("fill", "rgba(0,0,0,0.65)")   // semi-transparent dark
                        .style("font-family", "Segoe UI, Verdana, sans-serif")
                        .text("ℹ️ Hover over a state to see value");
                });
            ...
            function updateMap(selectedYear) {
                ...
                legendGroup.append("g")
                    ...
                    .call(legendAxis)
                    .selectAll("text")
    .style("font-size", "16px") // increase from default 10-12px
    .style("font-weight", "bold");

                // Add arrow indicator for hover
                const arrow = legendGroup.append("polygon")
                    .attr("points", "0,0 20,0 10,20") // much bigger triangle // triangle pointing up
                    .attr("fill", "black")
